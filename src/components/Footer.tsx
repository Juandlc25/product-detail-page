...
const Footer = () => {
  ...
  return (
    <>
      <div className="h-[120px] flex w-full font-inter bg-[#474d57] justify-between px-8">
        <div className="flex flex-col text-white h-full justify-center">
          <span className="font-medium text-3xl">
            Join our newsletter and get offters
          </span>
          <span className="font-normal text-xl">Sign up our newsletter</span>
        </div>
        <div className="flex items-center ">
          <input
            className="px-4 h-[73px] w-[350px]"
            placeholder="Enter your email"
            type="text"
          />
          <button className="bg-[#E73C17] h-[73px] w-[268px] text-white px-6 font-semibold text-xl">
            SUBSCRIBE
          </button>
        </div>
      </div>
      <div className="flex font-inter w-full flex-col h-[573px] bg-[#2F333A] text-white pt-10 pl-10 pr-10">
